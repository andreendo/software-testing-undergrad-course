...
class EmissarioTest {
	...
	// 1, 3, 4, 5, 7, 8, 15, 17	
	@Test
	void testUsuariosNaoEncontrados() {
		var daoMock = mock(UsuarioDAO.class);
		var usuarios = new ArrayList<Usuario>();
		usuarios.add(new Usuario("andre", "andre@mail.com"));
		when(daoMock.getAllUsuarios())
			.thenReturn(usuarios);
	...
	// 1, 3, 4, 5, 7, 8, 9, 10, 11, 12, 13, 8, 15, 16
	@Test
	void testMensagemEnviada() {
		var daoMock = mock(UsuarioDAO.class);
		var usuarios = new ArrayList<Usuario>();
		usuarios.add(new Usuario("andre", "andre@mail.com"));
		when(daoMock.getAllUsuarios())
		...
		var emailMock = mock(ServidorDeEmail.class);
		when(emailMock.enviar(anyString()))
			.thenReturn(true);
		...
		nomes.add("andre");
		var res = emissario.enviarPara(nomes);
